...
class VimEmulationAcceptanceTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.basic_editor = self.factory.create_new_editor(self.pyroom_config)
    ...
    def test_that_we_can_type_normally_if_vim_emulation_mode_is_off(self):
        ...
        default_basic_editor = self.factory.create_new_editor(default_pyroom_config)
    ...
    def test_that_vim_emulator_object_is_not_created_in_editor(self):
        ...
        default_basic_editor = self.factory.create_new_editor(pyroom_config)
